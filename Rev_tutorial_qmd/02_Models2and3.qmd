...
To interpret a coefficient (β) for a given level of RANK relative to the reference level, you must exponentiate it.
...
Calculate the multiplicative factor: $exp(-0.018) \approx 0.982$.

Convert to a percentage change: $(0.982 - 1) * 100\% = -1.7\%$.


The concise interpretation is: 

"The scaled mass index for subordinate individuals is, on average, 1.7% lower than that of the dominant reference group."
