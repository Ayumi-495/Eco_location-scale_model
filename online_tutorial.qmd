...
#' [ ERICK HERE. I don't know that way of making them pretty. But there is a helper function..]
# Problem is, you still need to extract the malarkey from confint(m) and align it
# which is super annoying. 
# I have written custom functions to do that in the past but I don't have time right now :(
model2_2.tidy <- model2_2 %>%
  tidy()
...
fc
#' [EJL: Would be good to explain how to interpret the LOO results]
#     elpd_diff se_diff
# fit2   0.0       0.0  
# fit1 -10.3       7.6  
```
